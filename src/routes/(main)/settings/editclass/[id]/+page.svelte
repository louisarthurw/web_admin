<script>
	...
	const businessClass = classes.find((c) => c.id === parseInt(classId));
		...
		>
			...
			<div>
				...
				<div class="flex space-x-2 items-center">
					...
					<input
						name="minimum"
						value={businessClass.modal_minimal}
						type="number"
					...
					<input
						name="maximum"
						value={businessClass.modal_maksimal}
						type="number"
